 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `⚡ ${pmenus} SPEED BOT`, rowId: ".speed", description: "╰► Menampilkan kecepatan respon BOT Versi Jawa"},
	...
	rows: [
	    {title: `🔖 ${pmenus} SEWA`, rowId: ".sewa", description: "Menampilkan list Rego Sewabot Versi Jawa"},
	    {title: `🌟 ${pmenus} BUY PREMIUM`, rowId: ".premium", description: "Menampilkan list Rego premium"},
	    {title: `💹 ${pmenus} DONASI`, rowId: ".donasi", description: 'Support BOT Ben Rodok fast Respon'},
	]
	},{
	title: `${htki} ▮𝗠𝗲𝗻𝘂 ${htka}`,
	rows: [
	    {title: `🌱 ${pmenus}  〚 All Menu 〛-𐑂`, rowId: ".? all", description: "╰► waduh,kok langsung Kabeh"},
	    {title: `🌱 ${pmenus} 〚 Rpg 〛-𐑂`, rowId: ".? rpg", description: "╰► Calon Cah petualang kih... -𐑂"},
	{title: `✨ ${pmenus} 〚 Exp 〛-𐑂`, rowId: ".? xp", description: "╰► Lak wes level 100 Oleh hadiah cok (≧▽≦)"},
	{title: `🎮 ${pmenus} 〚 Game 〛-𐑂`, rowId: ".? game", description: "╰► Bg kowe maen game opo cok?.... >-<"},
	{title: `🧩 ${pmenus} 〚 Fun 〛-𐑂`, rowId: ".? fun", description: "╰► we gabut to cok?"},
	{title: `🐚 ${pmenus} 〚 Kerang 〛-𐑂`, rowId: ".? kerangajaib", description: "╰► We arep takon opo to?..."},
	{title: `📑 ${pmenus} 〚 Quotes 〛-𐑂`, rowId: ".? quotes", description: "╰► Random Inspirasi :3"},
	{title: `⛩️ ${pmenus} 〚 Anime 〛-𐑂`, rowId: ".? anime", description: "╰► kowe wibu to cok?"},
	{title: `🔞 ${pmenus} 〚 Nsfw 〛-𐑂`, rowId: ".? nsfw", description: "╰► Tch, Ketoro Lak sange"},
	{title: `🌟 ${pmenus} 〚 Premium 〛-𐑂`, rowId: ".? premium", description: "╰► Only premium Users"},
	{title: `🎭 ${pmenus} 〚 Anonymous chat 〛-𐑂`, rowId: ".? anonymous", description: "╰► Karo Uwong Gak dikenal"},
	{title: `📖 ${pmenus} 〚 Islamic 〛-𐑂`, rowId: ".? quran", description: "╰► Tobat Ayo bang"},
	{title: `🌎 ${pmenus} 〚 Internet 〛-𐑂`, rowId: ".? internet", description: "╰► Ndolek sesuatu diBOT"},
  {title: `🌎 ${pmenus}   〚 berita 〛-𐑂`, rowId: ".? berita", description: "╰► Ndolek berita Seng anyar"},
	{title: `📩 ${pmenus} 〚 IDownloader 〛-𐑂`, rowId: ".? downloader", description: "╰► Rasah download seng aneh-aneh, cok (≧▽≦)"},
	{title: `🎨 ${pmenus} 〚 Stikers 〛-𐑂`, rowId: ".? stiker", description: "╰► Nggawe Sticker diBOT"},
	{title: `✏️ ${pmenus} 〚 Nulis 〛-𐑂`, rowId: ".? nulis", description: "╰► Nulis kok males kak?"},
	{title: `🎧 ${pmenus} 〚 Audio 〛-𐑂`, rowId: ".? audio", description: "╰► Ubah Audio dengan Filter"},
	{title: `🏢 ${pmenus} 〚 Group 〛-𐑂`, rowId: ".? group", description: "╰► Only Groups"},
	{title: `👑 ${pmenus} 〚 Admin 〛-𐑂`, rowId: ".? admin", description: "╰► Only Admin Group"},
	{title: `🗂️ ${pmenus} 〚 Database 〛-𐑂`, rowId: ".? database", description: "╰► Nyimpen sesuatu diBOT"},
	{title: `🛠️ ${pmenus} 〚 tools 〛-𐑂`, rowId: ".? tools", description: "╰► Mungkin tools iki Iso membantu?"},
	{title: `ℹ️ ${pmenus} 〚 Info 〛-𐑂`, rowId: ".? info", description: "╰► Info info BOT"},
	{title: `👩‍💻 ${pmenus} 〚 owner 〛-𐑂`, rowId: ".? owner", description: "╰► Owner Only!"},
	{title: `❓ ${pmenus} 〚 No katogori 〛-𐑂`, rowId: ".? nocategory", description: "╰► Fitur tanpa kategory!"},
	]
  },
]
...
//-------DOC TEMPLATE
    ...
    //------------------- BUTTON VID
    //conn.sendButton(m.chat, text, wm, 'https://youtu.be/3ONnszQtwz0', [['sᴘᴇᴇᴅ〽️', '.speed'],['ᴏᴡɴᴇʀ🤍', '.owner'],['ᴅᴏɴᴀsɪ💌', '.donasi']],ftoko, { gifPlayback: true, contextInfo: { externalAdReply: {title: namebot, body: bottime, sourceUrl: sig, thumbnail: fs.readFileSync('./thumbnail.jpg') }}})
...
function ucapan() {
  ...
  let res = "Wes meh subuh ki cok turu kono loh🥱"
  if (time >= 4) {
    res = "Isuk cok 🌄"
  }
  if (time >= 10) {
    res = "Selamat awan cok ☀️"
  }
  if (time >= 15) {
    res = "Selamat Sore cok 🌇"
  }
  if (time >= 18) {
    res = "bengi cok 🌙"
  }
